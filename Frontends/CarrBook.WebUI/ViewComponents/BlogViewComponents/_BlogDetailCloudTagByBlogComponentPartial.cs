...
namespace CarrBook.WebUI.ViewComponents.BlogViewComponents
{
    public class _BlogDetailCloudTagByBlogComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:44365/api/TagClouds/GetTagClodByBlogId?id=" + id);
